...
procedure test_TPrimary;
   begin
      ...
      test_only_for_successful_compilation ('type tc=class function entry f:int8; begin end; begin end; var i: int8; c: tc; begin i := c.f end.');
      test_only_for_successful_compilation ('type tc=class function entry f:int8; begin end; begin end; var i: int8; c: tc; begin with c do i := f end.');
      test_only_for_successful_compilation ('type tc=class property entry prop: int8; get: begin end; begin end; var i: int8; c: tc; begin i := c.prop end.');
      ...
      test_only_for_successful_compilation ('type tm=monitor var q: queue; begin if empty(q) then end; begin end.');
      ...
      test_compile_error_generation ('type tc=class property entry prop: int8; begin end; var i: int8; c: tc; begin i := c.prop end.', err_write_only_property, 'prop end.');
      test_compile_error_generation ('type tc=class procedure entry proc; begin end; begin end; var i: int8; c: tc; begin i := c.proc end.', err_procedure_has_no_result, 'proc end.');

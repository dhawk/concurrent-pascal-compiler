...
INITIALIZATION
   compiler_out_hex_files_path := ExtractFileDir(ParamStr(0)) + '/temp/pic18x_simulator_test_cases/hex_tests/';
   compiler_out_asm_files_path := ExtractFileDir(ParamStr(0)) + '/temp/pic18x_simulator_test_cases/asm_tests/';

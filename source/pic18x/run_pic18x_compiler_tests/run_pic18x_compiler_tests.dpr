...
uses
  ...
  run_pic18x_compiler_tests_aboutbox_unit in 'run_pic18x_compiler_tests_aboutbox_unit.pas' {PIC18xAboutBoxForm1},
...
{$ENDIF}
  ...
  Application.Run
      ...
      begin
         ...
         writeln ('      otherwise runs pic18x compiler tests.');
         writeln
      end
end.

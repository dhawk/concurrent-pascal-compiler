...
procedure TPICFileParserThread.ProcessFile  (file_name: string);
   ...
   begin
      ...
      FileAge (pic_file_directory + file_name, pic_file_date);
      OutputSource ('//========================================================================');
      OutputSource ('// ' + ChangeFileExt(file_name, '.inc'));
      OutputSource ('//    PIC18x Concurrent Pascal Compiler');
      OutputSource ('//    DO NOT EDIT!  Auto-generated by pic18x_include_file_generator.exe');
      OutputSource ('//    Derived from MPLABX ' + mplabx_version + ' ' + file_name + ' ' + FormatDateTime ('YYYY-MM-DD', pic_file_date));
      OutputSource ('//    github:');
      OutputSource ('//        repository: https://github.com/dhawk/concurrent-pascal-compiler');
      OutputSource ('//        pages: http://dhawk.github.io/concurrent-pascal-compiler');
      OutputSource ('//========================================================================');
      OutputSource ('');

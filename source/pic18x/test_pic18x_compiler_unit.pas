...
procedure test34;
   begin
      ...
      add ('        var j: int16;');
      add ('        procedure entry p1 (var x: int16);');
      add ('          begin');
      add ('             x := j');
      add ('          end;');
      add ('        procedure entry p2 (ii: int16);');
      add ('          begin');
      add ('             j := ii');
      add ('          end;');
      add ('        procedure entry p3 (var kk: int16);');
      add ('          begin');
      add ('             kk := r.j');
      add ('          end;');
      add ('        begin');
...
procedure test52;
   begin
      ...
      add ('  tc = class');
      add ('    var x: int8;');
      add ('    procedure entry put (xx: int8);');
      add ('       begin x := xx + 10');
      add ('       end;');
      add ('    function entry gget: int8;');
      add ('      begin gget := x + 20 end;');
      add ('   begin');
      add ('   end;');
      add ('var');
...
procedure test67;    // eeprom
   begin
      ...
      add ('         eeprom');
      add ('            i: int16;');
      add ('         function entry f: int16;');
      add ('            begin');
      add ('               f := i');
      add ('            end;');
      add ('         function entry f2: int16;');
      add ('            begin');
      add ('               f2 := i + 3');
      add ('            end;');
      add ('         begin');
...
procedure test69;    // string assignment
   begin
      ...
      add ('      s2: string[2];');
      add ('      szz: string [1];');
      add ('   procedure entry x (var sp: string);');
      add ('      begin');
      add ('         sp := s');
      add ('      end;');
      add ('   property entry ps: string;');
      add ('      get: begin ps := s end;');
      add ('   procedure pex (eeprom s: string);');
      add ('      var c: char := ''e'';');
      add ('      begin s := c end;');
      add ('   function entry getex1: string;');
      add ('      begin');
      add ('         pex (ex1);');
      add ('         getex1 := ex1');
      add ('      end;');
      add ('//   procedure entry pexov;');
      add ('//      begin pex (ex0) end;');
      add ('   function entry fez: uint8;');
      add ('      begin');
      add ('        sz.strlen := 1;');
      add ('        sz := szz;');
      add ('        fez := sz.strlen');
      add ('      end;');
      add ('   procedure entry teste0 (var iera, iee, iero: uint8);');
      add ('      begin');
...
procedure test70;    // eeprom string assignment
   begin
      ...
      add ('            sr: string [3];');
      add ('            se: string [3];');
      add ('         function entry fs: string;');
      add ('            begin');
      add ('               fs := s');
      add ('            end;');
      add ('         procedure entry test_rom;');
      add ('            begin');
      add ('               sr := r_init;');
      add ('            end;');
      add ('         function entry fs2: string;');
      add ('            begin');
      add ('               fs2 := sr;');
      add ('               e := r_init;');
      add ('            end;');
      add ('         procedure entry test_eeprom;');
      add ('            begin');
      add ('               se := s;');
      add ('            end;');
      add ('         function entry fs3: string;');
      add ('            begin');
      add ('               fs3 := se;');
      add ('               e := se;');
      add ('            end;');
...
procedure test71;    // strlen assignment
   begin
      ...
      add ('    function entry slen: uint8;');
      add ('      begin slen := s.strlen end;');
      add ('    function entry smax: uint8;');
      add ('      begin smax := s.maxstrlen end;');
      add ('    procedure entry setlen (i: uint8);');
...
procedure test72;    // maxstrlen
   begin
      ...
      add ('           x := ss.maxstrlen');
      add ('        end;');
      add ('     function entry fm: uint8;');
      add ('        begin');
      add ('          fm := x(s)');
      add ('        end;');
      add ('     function entry fd: uint8;');
      add ('        rom c:int8=5;');
      add ('        begin');
      add ('           fd := s.maxstrlen');
      add ('        end;');
...
procedure test73;  // strappend
   begin
      ...
      add ('   rom');
      add ('      rs: string[5] = ''aBc'';');
      add ('   function entry read_ese: string;');
      add ('     begin');
      add ('       read_ese := ese');
      add ('     end;');
      add ('   function entry read_esram: string;');
      add ('     begin');
      add ('       read_esram := esram');
      add ('     end;');
      add ('   procedure entry p;');
      add ('      begin');
      add ('         s.strappend (''x'')');
      add ('      end;');
      add ('   function entry f: string;');
      add ('      var t: string[2];');
      add ('      begin');
      add ('         t := s;');
      add ('         f := t');
      add ('      end;');
      add ('   function entry ff: string;');
      add ('     begin');
      add ('        ff := ss');
      add ('     end;');
      add ('   procedure entry pp;');
      add ('     begin');
      add ('       ss.strappend(es)');
      add ('     end;');
      add ('   function entry read_esr: string;');
      add ('     begin');
      add ('       esr.strappend (rs);');
      add ('       read_esr := esr');
      add ('     end;');
      add ('   function entry read_ec: string;');
      add ('     begin');
      add ('       read_ec := ec');
      add ('     end;');
      add ('   begin');
...
procedure test79;  // compare ram str to eeprom str
   ...
   begin
      ...
      add ('         var s: string[5];');
      add ('      procedure entry equal (var b: boolean; s1, s2: string);');
      add ('         begin');
      add ('            e := s1;');
      add ('            s := s2;');
      add ('            b := e = s');
      add ('         end;');
      add ('      procedure entry not_equal (var b: boolean; s1, s2: string);');
      add ('         begin');
      add ('            e := s1;');
      add ('            s := s2;');
      add ('            b := e <> s');
      add ('         end;');
      add ('      procedure entry less (var b: boolean; s1, s2: string);');
      add ('         begin');
      add ('            e := s1;');
      add ('            s := s2;');
      add ('            b := e < s');
      add ('         end;');
      add ('      procedure entry greater (var b: boolean; s1, s2: string);');
      add ('         begin');
      add ('            e := s1;');
      add ('            s := s2;');
      add ('            b := e > s');
      add ('         end;');
      add ('      procedure entry lessorequal (var b: boolean; s1, s2: string);');
      add ('         begin');
      add ('            e := s1;');
      add ('            s := s2;');
      add ('            b := e <= s');
      add ('         end;');
      add ('      procedure entry greaterorequal(var b: boolean; s1, s2: string);');
      add ('         begin');
      add ('            e := s1;');
      add ('            s := s2;');
      add ('            b := e >= s');
...
procedure test83;  // compare eeprom str to char
   begin
      ...
      add ('           procedure entry test (var b: ba; ss: string; c: char);');
      add ('              begin');
      add ('                 s := ss;');
      add ('                 b[0] := s = c;');
      add ('                 b[1] := s <> c;');
   ...
   begin
      ...
      add ('         eeprom e: string[5];');
      add ('         var s: string[5];');
      add ('      procedure entry equal (var b: boolean; rom s1, s2: string);');
      add ('         begin');
      add ('            e := s1;');
      add ('            s := s2;');
      add ('            b := e = s');
      add ('         end;');
      add ('      procedure entry not_equal (var b: boolean; rom s1, s2: string);');
      add ('         begin');
      add ('            e := s1;');
      add ('            s := s2;');
      add ('            b := e <> s');
      add ('         end;');
      add ('      procedure entry less (var b: boolean; rom s1, s2: string);');
      add ('         begin');
      add ('            e := s1;');
      add ('            s := s2;');
      add ('            b := e < s');
      add ('         end;');
      add ('      procedure entry greater (var b: boolean; rom s1, s2: string);');
      add ('         begin');
      add ('            e := s1;');
      add ('            s := s2;');
      add ('            b := e > s');
      add ('         end;');
      add ('      procedure entry lessorequal (var b: boolean; rom s1, s2: string);');
      add ('         begin');
      add ('            e := s1;');
      add ('            s := s2;');
      add ('            b := e <= s');
      add ('         end;');
      add ('      procedure entry greaterorequal(var b: boolean; rom s1, s2: string);');
      add ('         begin');
      add ('            e := s1;');
      add ('            s := s2;');
      add ('            b := e >= s');
...
procedure test90;    // test write to eeprom packed record with constants
   begin
      ...
      add ('   procedure entry p (var p1,p2,p3,p4: tpr);');
      add ('      begin');
      add ('        p1 := pr1;');
      add ('        p2 := pr2;');
      add ('        p3 := pr3;');
...
procedure test99;    // test strpos eeprom string in ram string
   begin
      ...
      add ('      eeprom');
      add ('         substr: string[15];');
      add ('      function entry f (s, ss: string): uint8;');
      add ('         var str: string [20];');
      add ('         begin');
      add ('            substr := ss;');
      add ('            f := s.strpos (substr)');
      add ('         end;');
      add ('      begin');
      add ('      end;');
      add ('   str: string[10];');
...
procedure test101;
   begin
      ...
      add ('         eeprom');
      add ('            substr: string[10];');
      add ('      function entry f (rom str: string; s: string): uint8;');
      add ('         begin');
      add ('            substr := s;');
      add ('            f := str.strpos(substr)');
      add ('         end;');
      add ('      begin');
      add ('      end;');
      add ('rom');
...
procedure test104;    // test strpos rom string in eeprom string
   begin
      ...
      add ('      eeprom');
      add ('         es: string[15];');
      add ('      function entry f (s: string; rom ss: string): uint8;');
      add ('         var str: string [20];');
      add ('         begin');
      add ('            es := s;');
      add ('            f := es.strpos (ss)');
      add ('         end;');
      add ('      function entry f2 (s: string): uint8;');
      add ('         begin');
      add ('            es := s;');
      add ('            f2 := es.strpos (''ef'');');
      add ('         end;');
...
procedure test107;
   begin
      ...
      add ('        function entry f (s: string; c: char): uint8;');
      add ('           begin');
      add ('              es := s;');
      add ('              f := es.strpos(c)');
      add ('           end;');
...
procedure test110;  // dropped cycle from reset timer routines
   begin
      ...
      add ('         function entry f(i,c: uint16): uint24;');
      add ('            begin');
      add ('               TMR3.TMRx := i;');
...
procedure test117;  // push single eeprom unsigned bit
   begin
      ...
      add ('c: class');
      add ('      eeprom v: t;');
      add ('function entry f0 (i: uint8): uint8;');
      add ('   begin');
      add ('      v.i := i;');
      add ('      f0 := v.i0');
      add ('   end;');
      add ('function entry f1 (i: uint8): uint8;');
      add ('   begin');
      add ('      v.i := i;');
      add ('      f1 := v.i1');
      add ('   end;');
      add ('function entry f2 (i: uint8): uint8;');
      add ('   begin');
      add ('      v.i := i;');
      add ('      f2 := v.i2');
      add ('   end;');
      add ('function entry f3 (i: uint8): uint8;');
      add ('   begin');
      add ('      v.i := i;');
      add ('      f3 := v.i3');
      add ('   end;');
      add ('function entry f4 (i: uint8): uint8;');
      add ('   begin');
      add ('      v.i := i;');
      add ('      f4 := v.i4');
      add ('   end;');
      add ('function entry f5 (i: uint8): uint8;');
      add ('   begin');
      add ('      v.i := i;');
      add ('      f5 := v.i5');
      add ('   end;');
      add ('function entry f6 (i: uint8): uint8;');
      add ('   begin');
      add ('      v.i := i;');
      add ('      f6 := v.i6');
      add ('   end;');
      add ('function entry f7 (i: uint8): uint8;');
      add ('   begin');
      add ('      v.i := i;');
      add ('      f7 := v.i7');
      add ('   end;');
...
procedure test122;    // local stack addressing, direct and indirect
   begin
      ...
      add ('var x: string[89];');
      add (' begin');
      add ('   fdd := 7');   // fdd direct 5e,5f
      add (' end;');
      add ('function fdi: uint16;');
      add ('var x: string[90];');
      add (' begin');
      add ('   fdi := 8');   // fdi indirect
      add (' end;');
      ...
      add ('   i: uint16 := 6;');
      add (' begin');
      add ('   fsi := i');   // i indirect
      add (' end;');
      add ('function fmd (var s: string): uint8;');
      add ('  var x: string [93];');
      add ('  begin');
      add ('    fmd := s.maxstrlen');   // s.maxstrlen direct 5f
      add ('  end;');
      add ('function fmi (var s: string): uint8;');
      add ('  var x: string [94];');
      add ('  begin');
      add ('    fmi := s.maxstrlen');   // s.maxstrlen indirect
      add ('  end;');
      ...
      add ('        fi := ss.maxstrlen;');
      add ('      end;');
      add ('    function entry fdd: uint8;');
      add ('      begin');
      add ('        fdd := fd(s) ');
      add ('      end;');
      add ('    function entry fii: uint8;');
      add ('      begin');
      add ('        fii := fi(s) ');
      add ('      end;');
      add ('    begin');
...
procedure test123;
   begin
      ...
      add ('           f2 := f(ii);  ');
      add ('        end;');
      add ('      function entry ff1: int16;');
      add ('        begin');
      add ('          i := $123;');
      add ('          ff1 := f1(i)');
      add ('        end;');
      add ('      function entry ff2: int16;');
      add ('        begin');
      add ('          i := $456;');
      add ('          ff2 := f2(i)');
      add ('        end; ');
...
procedure test125;
   begin
      ...
      add ('         s := c ');
      add ('      end;');
      add ('  function entry f1: char;');
      add ('     begin');
      add ('        pnear(ss);');
      add ('        f1 := ss[1]');
      add ('     end;');
      add ('  function entry f2: char;');
      add ('     begin');
      add ('        pfar(ss);');
      add ('        f2 := ss[1]');
      add ('     end;');
...
procedure test127;    // test "simple" index calculations
   begin
      ...
      add ('        function entry f8 (idx: uint3): uint8;');
      add ('          begin');
      add ('            f8 := arr8[idx]');
      add ('          end;');
      add ('        function entry f16 (idx: uint3): uint16;');
      add ('          begin');
      add ('            f16 := arr16[idx]');
      add ('          end;');
...
procedure test128;    // test with eeprom
   begin
      ...
      add ('          f := ii');
      add ('        end;');
      add ('      function entry ff: int16;');
      add ('         begin');
      add ('           with x do ff := f(j);  ');
      add ('         end;');
      add ('      function entry fi: int16;');
      add ('        begin');
      add ('          with r do');
      add ('            fi := i');
      add ('        end;');
      add ('      function entry fj: int16;');
      add ('        begin');
      add ('          with r do');
      add ('            fj := j');
      add ('        end;');
...
procedure test131;    // for loop with constants
   begin
      ...
      add ('          i: uint8;');
      add ('          j: uint16;');
      add ('      function entry f8: uint8;');
      add ('        begin f8 := i8 end;');
      add ('      function entry f16: uint16;');
      add ('        begin f16 := i16 end;');
      add ('      begin');

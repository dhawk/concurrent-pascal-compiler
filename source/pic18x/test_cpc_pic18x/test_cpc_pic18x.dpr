...
{$ENDIF}
  ...
  test_pic18x_compiler_aboutbox_unit in 'test_pic18x_compiler_aboutbox_unit.pas' {TestCPCPIC18xAboutBox},
...
begin
  ...
  Application.CreateForm(TTestCPCPIC18xAboutBox, TestCPCPIC18xAboutBox);
  Application.Run;
end.
